...
$routes->group('admin', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->group('akademik', function ($routes) {
        ...
        $routes->group('legalisir-dokumen', function ($routes) {
            ...
            $routes->post('update-status', 'LegalisirController::admin_prodi_update_status_legalisir', ['as' => 'admin_update_status_legalisir']);
            $routes->post('delete', 'LegalisirController::delete_pengajuan', ['as' => 'admin_delete_pengajuan']);
        });
        // Registrasi Alumni
