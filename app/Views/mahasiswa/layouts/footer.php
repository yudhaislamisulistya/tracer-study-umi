...
<div class="footer py-2 py-lg-0 my-5 d-flex flex-lg-column " id="kt_footer">
    ...
    <div class=" container-fluid  d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="#" target="_blank" class="text-dark-75 text-hover-primary">Crafted with love by IT Team - Universitas Muslim Indonesia</a>
        </div>
        <!--end::Copyright-->
    ...
    <div class="sidebar-content flex-column-fluid pb-10 pt-9 px-5 px-lg-10">
        ...
        <?php
            if(get_data_registrasi()->akses == 1){
                echo '<div class="card card-custom bg-warning mb-5">
                    <div class="card-header border-0">
                        <div class="card-title">
                            ...
                            <h3 class="card-label text-white">
                                Status Validasi Akun KKN
                            </h3>
                        </div>
                    </div>
                    <div class="separator separator-solid separator-white opacity-20"></div>
                    <div class="card-body text-white">
                        Akun Dalam Proses Validasi Oleh LPKM...
                    </div>
                </div>';
            }else if (get_data_registrasi()->akses == 2){
                echo '<div class="card card-custom bg-success mb-5">
                    <div class="card-header border-0">
                        <div class="card-title">
                            <span class="card-icon">
                                <i class="flaticon2-chat-1 text-white"></i>
            ...
            <div class="card-body pt-8">
                ...
                <div class="d-flex align-items-center mb-10">
                    ...
                    <div class="d-flex flex-column font-weight-bold">
                        <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Rilis Aplikasi</a>
                        <span class="text-muted">7 September 2021</span>
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Item-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('http://siakad.umi.ac.id/doc/foto/mahasiswa/<?=  get_data_mahasiswa_gamelan()->D_FOTO_MAHASISWA ?>')"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
                    <?= get_data_mahasiswa_gamelan()->NAMA_MAHASISWA ?>
                </a>
                <div class="text-muted mt-1">
                    <?= Session()->get('C_USERNAME') ?>
                </div>
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            <span
                                class="navi-text text-muted text-hover-primary"><?= get_data_mahasiswa_gamelan()->TEMPAT_LAHIR ?>,
                                <?= get_data_mahasiswa_gamelan()->  TGL_LAHIR ?></span>
                        </span>
                    </a>
