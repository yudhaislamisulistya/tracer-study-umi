<ul class="menu-nav ">
    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
        <a href="<?= route_to('admin_prodi_dashboard') ?>" class="menu-link menu-toggle">
    ...
    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
        <a href="<?= route_to('admin_prodi_perusahaan_alumni') ?>" class="menu-link menu-toggle">
            <span class="svg-icon menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
    ...
    <li class="menu-item" aria-haspopup="true">
        <a href="<?= route_to('admin_prodi_legalisir') ?>" class="menu-link ">
    ...
    <!-- Info Loker -->
    <li class="menu-item" aria-haspopup="true"><a href="<?= route_to('admin_prodi_lowongan_kerja') ?>" class="menu-link ">
            <span class="svg-icon menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
            ...
            <span class="menu-text">Info Loker</span>
        </a>
    </li>
    <li class="menu-item" aria-haspopup="true"><a href="<?= route_to('admin_prodi_daftar_alumni') ?>" class="menu-link ">
            <span class="svg-icon menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
    ...
    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a href="javascript:;" class="menu-link menu-toggle">
        ...
        <div class="menu-submenu "><i class="menu-arrow"></i>
            <ul class="menu-subnav">
                <li class="menu-item " aria-haspopup="true">
                    <a href="<?= route_to('admin_prodi_berita') ?>" class="menu-link ">
                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                        <span class="menu-text">Berita Alumni</span>
                    </a>
                </li>
                <li class="menu-item " aria-haspopup="true">
                    <a href="<?= route_to('admin_prodi_artikel') ?>" class="menu-link ">
                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                        <span class="menu-text">Artikel Alumni</span>
                    </a>
                </li>
                <li class="menu-item " aria-haspopup="true">
                    <a href="<?= route_to('admin_prodi_event') ?>" class="menu-link ">
                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
