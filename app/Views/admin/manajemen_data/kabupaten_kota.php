        ...
        <div class="d-flex align-items-center mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="<?= route_to('admin_kabupaten_kota') ?>" class="text-muted">
                            Kabupaten Kota
                        </a>
                    </li>
                </ul>
            ...
            <div class="card-body">
                <table id="alumniTable" class="table table-bordered table-checkable" style="width:100%">
                    ...
                    <tbody>
                        <!-- Get Data Negara -->
                        <?php
                        foreach (get_data_regencies() as $key => $value) {
                            echo '<tr>';
                            echo '<td>' . $value->id . '</td>';
                            echo '<td>' . get_data_provinsi_with_id($value->province_id)->name . '</td>';
