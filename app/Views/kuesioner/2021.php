                    ...
                    <form class="form" id="kt_form" action="<?= base_url('kuesioner_2021/store') ?>" method="POST">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="kuesioner-wajib">
                                ...
                                <legend class="text-uppercase font-size-sm font-weight-bold mt-5">Kuesioner Wajib</legend>
                                <hr />
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="f504" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f504)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" required type="radio">&nbsp; Ya, [1] Dalam Berapa Bulan Anda Mendapatkan Pekerjaan <input name="f502" size="5" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f502; ?>" class="width40" type="text"><br /><br />
                                                <input name="f504" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f504)) == '2') {
                                                                        echo "checked";
                                                                    } ?> value="2" required type="radio">&nbsp; Tidak, [2] Dalam Berapa Bulan Anda Mendapatkan Pekerjaan <input class="width40" name="f506" size="5" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f506; ?>" type="text"><br>

                                                <br><br>&nbsp;Berapa Rata-Rata Pendapatan Anda Perbulan? (take home pay) <input class="width40" name="f505" size="5" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f505; ?>" type="text"><br>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="f504" class="form-group">
                                    ...
                                    <div id="f18" class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="row">
                                                    <div class="col-sm-10">
                                                        Pilih Sumber Biaya <input class="width40" name="f18a" size="15" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f18a; ?>" type="text"><br>
                                                        Perguruan Tinggi <input class="width40" name="f18b" size="30" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f18b; ?>" type="text"><br>
                                                        Program Studi <input class="width40" name="f18c" size="30" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f18c; ?>" type="text"><br>
                                                        Tahun Masuk <input class="width40" name="f18d" size="30" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f18d; ?>" type="date"><br>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-5"></div>
                                            <div class="col-sm-7">
                                                <label>Partisipasi dalam proyek riset</label>
                                                <br />
                                    ...
                                    <div id="f3" class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <label>Perkuliahan</label>
                                                <br />
                                                <input id="f301" name="f301" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f301)) == '1') {
                                                                                    echo "checked";
                                                                                } ?> value="1" onclick="show3()" type="radio"> [1] Kira-kira <input name="f302" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f302; ?>" size="5" type="text" class="width40"> &nbsp;bulan sebelum lulus &nbsp;&nbsp;<br /><br />
                                                &nbsp;&nbsp;<input id="f301" name="f301" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f301)) == '2') {
                                                                                                echo "checked";
                                                                                            } ?> value="2" onclick="show3()" type="radio"> [2] Kira-kira <input name="f303" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f303; ?>" size="5" type="text" class="width40"> &nbsp;bulan sesudah lulus &nbsp;&nbsp;<br /><br />
                                                &nbsp;&nbsp;<input id="f301" name="f301" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f301)) == '3') {
                                                                                                echo "checked";
                                                                                            } ?> value="3" onclick="hide3()" type="radio"> [3] Saya tidak mencari kerja<br>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="f401" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f401)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Melalui iklan di koran/majalah, brosur <br>
                                                <input name="f402" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f402)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Melamar ke perusahaan tanpa mengetahui lowongan yang ada <br>
                                                <input name="f403" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f403)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Pergi ke bursa/pameran kerja <br>
                                                <input name="f404" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f404)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Mencari lewat internet/iklan online/milis <br>
                                                <input name="f405" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f405)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Dihubungi oleh perusahaan<br>
                                                <input name="f406" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f406)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Menghubungi Kemenakertrans<br>
                                                <input name="f407" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f407)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Menghubungi agen tenaga kerja komersial/swasta<br>
                                                <input name="f408" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f408)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Memeroleh informasi dari pusat/kantor pengembangan karir fakultas/universitas <br>
                                                <input name="f409" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f409)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Menghubungi kantor kemahasiswaan/hubungan alumni <br>
                                                <input name="f410" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f410)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Membangun jejaring (<i>network</i>) sejak masih kuliah <br>
                                                <input name="f411" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f411)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Melalui relasi (misalnya dosen, orang tua, saudara, teman, dll.)<br>
                                                <input name="f412" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f412)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Membangun bisnis sendiri<br>
                                                <input name="f413" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f413)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Melalui penempatan kerja atau magang<br>
                                                <input name="f414" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f414)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Bekerja di tempat yang sama dengan tempat kerja semasa kuliah <br>
                                                <input name="f415" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f415)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Lainnya: <br>
                                                <div class="row">
                                                    <div class="col-sm-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="f901" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f901)) == '1') {
                                                                        echo "checked";
                                                                    } ?> value="1" type="checkbox"> [1] Saya masih belajar/melanjutkan kuliah profesi atau pascasarjana<br>
                                                <input name="f902" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f902)) == '2') {
                                                                        echo "checked";
                                                                    } ?> value="2" type="checkbox"> [2] Saya menikah<br>
                                                <input name="f903" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f903)) == '3') {
                                                                        echo "checked";
                                                                    } ?> value="3" type="checkbox"> [3] Saya sibuk dengan keluarga dan anak-anak<br>
                                                <input name="f904" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f904)) == '4') {
                                                                        echo "checked";
                                                                    } ?> value="4" type="checkbox"> [4] Saya sekarang sedang mencari pekerjaan<br>
                                                <input name="f905" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f905)) == '5') {
                                                                        echo "checked";
                                                                    } ?> value="5" type="checkbox"> [5] Lainnya<br>
                                                <div class="row">
                                                    <div class="col-sm-10">
                                    ...
                                    <div id="f10" class="form-group">
                                        <div class="row">
                                            <label class="control-label col-sm-1"></label>
                                            <label class="control-label col-sm-4">Apakah anda aktif mencari pekerjaan dalam 4 minggu terakhir? <i> Pilihlah Satu Jawaban. </i> </label>
                                            <div class="col-sm-7">
                                                <div class="row">
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="col-sm-7">
                                                <span>
                                                    <input name="f1601" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1601)) == '1') {
                                                                            echo "checked";
                                                                        } ?> value="1" type="checkbox"> [1] Pertanyaan tidak sesuai; pekerjaan saya sekarang sudah sesuai dengan pendidikan saya.<br>
                                                    <input name="f1602" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1602)) == '2') {
                                                                            echo "checked";
                                                                        } ?> value="2" type="checkbox"> [2] Saya belum mendapatkan pekerjaan yang lebih sesuai<br>
                                                    <input name="f1603" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1603)) == '3') {
                                                                            echo "checked";
                                                                        } ?> value="3" type="checkbox"> [3] Di pekerjaan ini saya memeroleh prospek karir yang baik.<br>
                                                    <input name="f1604" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1604)) == '4') {
                                                                            echo "checked";
                                                                        } ?> value="4" type="checkbox"> [4] Saya lebih suka bekerja di area pekerjaan yang tidak ada hubungannya dengan pendidikan saya.<br>
                                                    <input name="f1605" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1605)) == '5') {
                                                                            echo "checked";
                                                                        } ?> value="5" type="checkbox"> [5] Saya dipromosikan ke posisi yang kurang berhubungan dengan pendidikan saya dibanding posisi sebelumnya<br>
                                                    <input name="f1606" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1606)) == '6') {
                                                                            echo "checked";
                                                                        } ?> value="6" type="checkbox"> [6] Saya dapat memeroleh pendapatan yang lebih tinggi di pekerjaan ini.<br>
                                                    <input name="f1607" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1607)) == '7') {
                                                                            echo "checked";
                                                                        } ?> value="7" type="checkbox"> [7] Pekerjaan saya saat ini lebih aman/terjamin/secure<br>
                                                    <input name="f1608" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1608)) == '8') {
                                                                            echo "checked";
                                                                        } ?> value="8" type="checkbox"> [8] Pekerjaan saya saat ini lebih menarik<br>
                                                    <input name="f1609" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1609)) == '9') {
                                                                            echo "checked";
                                                                        } ?> value="9" type="checkbox"> [9] Pekerjaan saya saat ini lebih memungkinkan saya mengambil pekerjaan tambahan/jadwal yang fleksibel, dll<br>
                                                    <input name="f1610" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1610)) == '10') {
                                                                            echo "checked";
                                                                        } ?> value="10" type="checkbox"> [10] Pekerjaan saya saat ini lokasinya lebih dekat dari rumah saya.<br>
                                                    <input name="f1611" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1611)) == '11') {
                                                                            echo "checked";
                                                                        } ?> value="11" type="checkbox"> [11] Pekerjaan saya saat ini dapat lebih menjamin kebutuhan keluarga saya.<br>
                                                    <input name="f1612" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1612)) == '12') {
                                                                            echo "checked";
                                                                        } ?> value="12" type="checkbox"> [12] Pada awal meniti karir ini, saya harus menerima pekerjaan yang tidak berhubungan dengan pendidikan saya.<br>
                                                    <input name="f1613" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1613)) == '13') {
                                                                            echo "checked";
                                                                        } ?> value="13" type="checkbox"> [13] Lainnya:<br>
                                                    <div class="row">
                                                        <div class="col-sm-10">
