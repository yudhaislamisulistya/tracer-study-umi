                ...
                <div class="card-body">
                    ...
                    <form class="form" id="kt_form" action="<?= base_url('kuesioner_2021/store') ?>" method="POST">
                        ...
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link flex-fill active" data-toggle="tab" href="#identitas-alumni">Identitas Alumni</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " data-toggle="tab" href="#kuesioner-wajib">Kuesioner Wajib</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="kuesioner-wajib">
                                <!-- Kuesioner Wajib -->
