        ...
        <div class="container">
            <div class="alert alert-custom alert-light-info fade show mb-5" role="alert">
                ...
                <div class="alert-text">
                    ...
                    Survey ini digunakan sebagai bahan evaluasi kinerja lulusan serta wujud nyata untuk meningkatkan mutu lulusan nantinya. Segala hal dalam kuesioner ini bersifat terbatas dan hanya digunakan sebagai bahan evaluasi internal Universitas Muslim Indonesia Universitas Muslim Indonesia. <br><br>
                    <hr>
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                            <form class="form-validate-jquery" action="<?= base_url('pengguna-non-kesehatan/store') ?>" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="jenis_pengguna_lulusan" value="Non Kesehatan">
                            <?= csrf_field() ?>
                            <fieldset class="mb-3">
                                ...
                                <fieldset class="mb-3">
                                    ...
                                    <p><span class="text-info">*)</span> Alumni yang dinilai adalah Universitas Muslim Indonesia</p>
                                ...
                                <fieldset class="mb-3">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Kepribadian <span class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="1" name="kepribadian" required>
                                                    Kurang
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="2" name="kepribadian">
                                                    Cukup
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="3" name="kepribadian">
                                                    Baik
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="4" name="kepribadian">
                                                    Sangat Baik
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <!-- 2 -->
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Prestasi/Kemampuan <span class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="1" name="prestasi" required>
                                                    Kurang
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="2" name="prestasi">
                                                    Cukup
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="3" name="prestasi">
                                                    Baik
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="4" name="prestasi">
                                                    Sangat Baik
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Kejujuran <span class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Tanggung Jawab <span class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="1" name="tanggung_jawab" required>
                                                    Kurang
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="2" name="tanggung_jawab">
                                                    Cukup
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="3" name="tanggung_jawab">
                                                    Baik
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="4" name="tanggung_jawab">
                                                    Sangat Baik
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Prakarsa <span class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="1" name="prakarsa" required>
                                                    Kurang
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="2" name="prakarsa">
                                                    Cukup
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="3" name="prakarsa">
                                                    Baik
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" value="4" name="prakarsa">
                                                    Sangat Baik
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-left"><div class="g-recaptcha" data-sitekey="6LeLwwcaAAAAAOrXVmim2KFEo50Vq_aU97xGbS_6" data-theme="light" data-type="image" ></div></div>
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <div class="form-check">
                                                <label class="form-check-label">
